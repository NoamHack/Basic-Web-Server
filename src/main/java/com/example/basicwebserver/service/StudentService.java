...
public interface StudentService {
    ...
    public void deleteStudent(Long studentId); // Delete a student by i
    List<StudentDTO> getStudentsWithNoGrades();
    List<StudentDTO> getStudentsWithAverageAbove(Double average);
}
